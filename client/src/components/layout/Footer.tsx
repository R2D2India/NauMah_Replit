    ...
    <footer className="bg-white border-t border-gray-200 py-6">
      <div className="container mx-auto px-4">
        ...
        <div className="mt-8 pt-6 border-t border-gray-200">
          <div className="text-center text-sm text-neutral-dark pt-4">
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-8">
        <div className="space-y-4">
          ...
          <p className="text-neutral-dark">
            ...
            Our mission is to empower expectant mothers with personalized guidance, making pregnancy journeys safer and more informed.
            We understand the challenges women face during pregnancy and are committed to providing 24/7 AI-powered support.
          </p>
          <div className="flex items-center space-x-2">
            <i className="fas fa-heartbeat text-primary text-lg"></i>
            <p className="text-neutral-dark">Dedicated to your well-being</p>
          </div>
        </div>
        <div className="space-y-4">
